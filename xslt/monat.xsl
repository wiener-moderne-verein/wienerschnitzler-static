        ...
        <html lang="de" class="h-100">
            <head>
                ...
                <xsl:variable name="doc_description">
                    <xsl:text>Schnitzlers Aufenthaltsorte nach Monaten – Monatliche Übersicht der Orte, an denen Arthur Schnitzler in Wien war</xsl:text>
                </xsl:variable>
                    ...
                    <div class="container-fluid my-4" id="main-content">
                        ...
                        <div class="map-container-wrapper">
                            ...
                            <div class="filter-column">
                                ...
                                <p class="text-start text-muted small mt-3">Auf dieser Seite werden
