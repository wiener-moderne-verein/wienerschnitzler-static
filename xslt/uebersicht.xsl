    ...
    <xsl:template match="/">
        <html class="h-100">
            ...
            <head>
                ...
                <xsl:variable name="doc_title" select="local:translate('uebersicht.title')"/>
                <xsl:variable name="doc_description" select="local:translate('uebersicht.meta_description')"/>
                ...
                <xsl:call-template name="nav_bar"/>
                    <main class="w-100">
                        <div class="container-fluid my-4" id="main-content">
                                ...
                                <h1><xsl:value-of select="local:translate('uebersicht.heading')"/></h1>
