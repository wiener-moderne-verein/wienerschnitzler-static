...
const columns = [
  ...
  },
  {
    headerFilter: "input",
    headerFilterParams: {
      "aria-label": "Filter affiliations"
    },
    title: "Affiliations",
    field: "Affiliations",
    formatter: "plaintext",
  ...
  },
  {
    headerFilter: "input",
    headerFilterParams: {
      "aria-label": "Filter place of residence and work"
    },
    title: "Place of Residence and Work",
    field: "Place of Residence and Work",
    formatter: "plaintext",
    resizable: true,
  },
...
const tabulator_cfg = {
  ...
  tabEndNewRow: false,
  ariaLabel: "Table of Schnitzler's locations"
};
...
function get_bold_name(row) {
  let label_string = `<a href="${row.linkToEntity}.html">${row['Place Name']}</a>`;
  return label_string;
}
...
function linkToDetailView (cell) {
  ...
  var linkText = cellData['Place Name']
