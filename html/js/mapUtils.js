...
function createPopupContent(feature) {
    ...
    `<a href="https://schnitzler-chronik.acdh.oeaw.ac.at/${date}.html" target="_blank">${date}</a>`).join('<br>');
    ...
    if (feature.properties.wohnort && Array.isArray(feature.properties.wohnort)) {
        ...
        `<li><a href="https://pmb.acdh.oeaw.ac.at/entity/${person.p_id.replace(/^#/, '')}/" target="_blank">${person.p_name}</a></li>`).join('');
